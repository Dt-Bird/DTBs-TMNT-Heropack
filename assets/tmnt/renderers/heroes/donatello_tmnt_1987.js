...
loadTextures({
    "layer1": "tmnt:donatello_tmnt_1987_layer1",
    "layer2": "tmnt:donatello_tmnt_1987_layer2",
    "beltloops": "tmnt:donatello_belt_loops_tmnt_1987",
...
function initEffects(renderer) {
    ...
    beltloops.setModel(utils.createModel(renderer, "tmnt:donatello_belt_loops_tmnt_1987", "beltloops"));
    beltloops.setOffset(-0.3, -14.5, 0.5);
